...
return!1}
function isObject(value){if(!isArray(value)&&(typeof value==='undefined'?'undefined':_typeof(value))=='object'){return!0}
return!1}
...
return copy}
function arrayDiff(arrayA,arrayB,compareEachElement){compareEachElement=compareEachElement||!1;var map={};var key;var ret=[];if(!compareEachElement){if(arrayA.length!==arrayB.length){ret.push(valueData(arrayA,arrayB,valueStatus.MODIFIED))}else{var a=arrayA.toString();var b=arrayB.toString();if(a!==b){ret.push(valueData(arrayA,arrayB,valueStatus.MODIFIED))}}
return ret}
